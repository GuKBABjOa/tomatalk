        ...
        <div v-else class="match-complete">
            ...
            <div>
                ...
                <div @click="toggleGameMethod" class="bg-white w-5/6 mx-auto py-2 cursor-pointer box">
                    <p class="whitebox_text">게임 방법 보기 <span class="mx-0 my-0" :class="['arrow', showGameMethod ? 'arrow-up' : 'arrow-down']"></span></p>
...
.fade-enter-to, .fade-leave-from {
    max-height: 200px; /* 적절한 max-height 값 설정 */
}
...
.arrow {
    ...
    padding: 0.5rem;
    transform: rotate(45deg); /* 기본은 아래 화살표 */
