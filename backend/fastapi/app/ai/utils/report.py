...
async def create_instruction() -> str:
    ...
    심사위원의 입장에서 각 참가자의 발언을 평가하고 점수를 부여할 거야.  
    ...
    AI는 아래 JSON 구조를 정확히 따라야 한다.  
    [
        {
            "participant": "A",
            "total": 85,
            "total_explanation": "총평",
            "reasoning": 32,
            "reasoning_explanation": "A는 낙태가 여성의 자기결정권이라는 주장을 일관되게 유지하며, 이로 인해 여성의 삶에 미치는 영향을 강조했습니다. 그러나 태아의 생명권에 대한 반박은 상대적으로 약했습니다. 예를 들어, '강제 출산은 여성의 삶을 위협한다'는 주장에 대해 구체적인 사례나 데이터를 통해 더 강력하게 뒷받침했으면 좋았을 것입니다.",
            "expression": 18,
            "expression_explanation": "A는 '자기결정권'과 '건강권'이라는 핵심 키워드를 반복적으로 사용하며 주장했습니다. 그러나 감정적 호소나 비유 등의 표현 기법을 더 활용하면 발언의 설득력을 높일 수 있었을 것입니다. 예를 들어, 강제 출산의 부정적 결과를 구체적인 사례로 제시하면 더 효과적일 것입니다.",
            "strategy": 18,
            "strategy_explanation": "A는 첫 번째 발언자로서 자신의 입장을 명확히 했으며, 상대방의 주장에 대한 반박을 통해 논의를 이끌었습니다. 그러나 반대 측의 주장에 대한 깊이 있는 반박이 부족했습니다. 예를 들어, 태아의 생명권에 대한 반박을 더 구체적으로 제시했으면 좋았을 것입니다.",
            "interaction": 17,
            "interaction_explanation": "A는 상대방의 주장에 대해 비교적 잘 대응했으나, 상대방의 논점에 대한 추가적인 질문이나 논의가 부족했습니다. 상대의 주장을 더욱 깊이 분석하고, 질문을 통해 논의를 확장했으면 더 나은 상호작용을 만들 수 있었을 것입니다."
        }
    ]
    """
